...
% Analyze Results of Weighted k-Means
fprintf("\n\nAnalyzing Weighted k-Means Result...\n");

% Load the Suggested Tags
fprintf("\nLoading Weighted k-Means Output...\n");
load('WeightedLabels');	% In variable kmeans_labels
kmeans_labels = weighted_labels;
fprintf("Weighted k-Means Output Loaded.\n");
...
fprintf("\tFeature 2\tFeature 8\tFeature 7");
...
fprintf("\nWeighted k-Means Result Analysis Done.\n");
