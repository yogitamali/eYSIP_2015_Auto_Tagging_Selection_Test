...
function [theta1, theta2, theta3] = trainNN(X, y, max_iters, num_classes),
	...
	costFunction = @(p) nnCostFunction(p, input_layer_size, hidden_layer_size_1, hidden_layer_size_2, output_layer_size, X, newY, lambda);
